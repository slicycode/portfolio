        ...
        <Container paddingTop={50}>
          ...
          <SimpleGrid columns={[1, 1, 2]} gap={8}>
            <Section delay={0.3}>
              ...
              <h3 className="text-xl text-center mt-2">Felix</h3>
            ...
            <Section delay={0.3}>
              <div>
                <Image
                  ...
                  alt="Kiabi"
                />
                <h3 className="text-xl text-center mt-2">Kiabi</h3>
            ...
            <Section delay={0.35}>
              ...
              <h3 className="text-xl text-center mt-2">Jobzura</h3>
            ...
            <Section delay={0.35}>
              ...
              <h3 className="text-xl text-center mt-2">Payzura</h3>
          ...
          <SimpleGrid columns={[1, 1, 2]} gap={8}>
            <Section delay={0.6}>
              ...
              <h3 className="text-xl text-center mt-2">Skoonova</h3>
            ...
            <Section delay={0.6}>
              ...
              <h3 className="text-xl text-center mt-2">AESFA</h3>
            ...
            <Section delay={0.65}>
              ...
              <h3 className="text-xl text-center mt-2">Crypto Yoyo Club</h3>
